...
// MARK: - Budget Sort Picker Sheet
struct BudgetSortPickerView: View {
    @Binding var selectedSort: HistoryView.BudgetSortOption
        ...
        NavigationView {
            ScrollView {
                LazyVStack(spacing: 12) {
                    ForEach(HistoryView.BudgetSortOption.allCases, id: \.self) { sortOption in
                        Button(action: {
                            ...
                            HStack(spacing: 16) {
                                ...
                                VStack(alignment: .leading, spacing: 2) {
                                    ...
                                    Text({
                                        ...
                                        case .budgetAmount: return "Highest to lowest"
                                        case .spentAmount: return "Highest to lowest"
                                        }
                                    }())
                                        .font(.caption)
                        ...
                        if sortOption != HistoryView.BudgetSortOption.allCases.last {
                            Rectangle()
